...
I used function called search() it runs everytime you write any character.
In the main page i used getAll() to get all the books that have been added to any shelf.
Every time you added a book to any shelf the update() run.
